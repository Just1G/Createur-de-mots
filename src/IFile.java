...
public class IFile {
    ...
    public void getNbOfDifferentCharacters(Statistics stats, String fileName)
    {
        try {
            ...
            while((line = reader.readLine()) != null) { //while a word is read
                stats.getNbOfCharacters(line);                //we analyse this word in an Statistics Object
            }
    ...
    public static void readFileAndMakeStats(Statistics stats, String fileName) {
        try {
            BufferedReader reader = new BufferedReader(new java.io.FileReader(fileName));
            //This statement goes into a try in case there is a problem with the file
